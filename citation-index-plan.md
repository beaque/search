...
- Output index size: **50-200 MB** (JSON)

### Peak Memory Usage (In-Memory Approach)
| Component | Memory |
|-----------|--------|
...
- [CommonCrawl Web Graph Releases](https://data.commoncrawl.org/projects/hyperlinkgraph/cc-main-2024-aug-sep-oct/index.html)
- [CommonCrawl Blog - Web Graph Updates](https://commoncrawl.org/blog/host--and-domain-level-web-graphs-may-june-and-july-2024)
- [CommonCrawl Statistics](https://commoncrawl.github.io/cc-crawl-statistics/)
